...
from server.py.services.api.crud.model_monitoring.model_endpoints import start_model_endpoint_creation_background_task
...
def get_or_create_project_deletion_background_task(
    ...
    try:
        task = framework.utils.background_tasks.InternalBackgroundTasksHandler().get_active_background_task_by_kind(
    ...
    return framework.utils.background_tasks.InternalBackgroundTasksHandler().create_background_task(
        background_task_kind,
    ...
    def _verify_project_is_deleted():
        try:
            ...
            if background_task_name := project_status.get(
                ...
                bg_task = framework.utils.background_tasks.InternalBackgroundTasksHandler().get_background_task(
