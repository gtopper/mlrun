...
def v2_serving_init(context, namespace=None):
    ...
    context.logger.info(f"111 v2_serving_init spec={spec}")
    server = GraphServer.from_dict(spec)
    context.logger.info(
        f"111 v2_serving_init server_model_endpoint_creation_task_name={server.model_endpoint_creation_task_name}",
    )
